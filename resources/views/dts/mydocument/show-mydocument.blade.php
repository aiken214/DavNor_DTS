...
<div class="card">
  ...
  @endif
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">My Document</h5>
    </div>
    <div class="card-body">
       <div class="row">
        <!--left side-->
        <div class="col-sm-6">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <h5 class="card-title">My Document Details</h5>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center gap-3">
                        ...
                        <a href="{{ route('dts.my-print-slip', $document->id) }}" target="new" class="btn rounded-pill btn-outline-danger-600 radius-8 px-20 py-11" style="width:100%">QRCode Attached Slip</a>
                        <a href="{{ route('dts.my-print-top-right', $document->id) }}"  target="new" class="btn rounded-pill btn-outline-lilac-600 radius-8 px-20 py-11" style="width:100%">@ Document Top Right</a>
                        <a href="{{ route('dts.my-print-bottom-right', $document->id) }}" target="new" class="btn rounded-pill btn-outline-info-600 radius-8 px-20 py-11" style="width:100%">@ Document Bottom Right</a>
                        <a href="{{ route('dts.my-print-bottom-left', $document->id) }}" target="new" class="btn rounded-pill btn-outline-success-600 radius-8 px-20 py-11" style="width:100%">@ Document Bottom Left</a>
