...
<div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    <h6 class="fw-semibold mb-0">Add  New DTS Document Types</h6>
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-sm-6">
                <h5 class="card-title mb-0">Create Doc Type</h5>
            </div>
            <div class="col-sm-6">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('dts.doc-types.store') }}">
            @csrf
            ...
            <div class="row">
                <div class="col-sm-8">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="typename" name="description"  required>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <select name="for_guest" id="selectforGuest" class="form-control">
                                <option value="" style="display: none; visibility: hidden;">Select</option>
